...
/**
 * Maneja la solicitud entrante de exploración de directorios locales bajo demanda.
 * Escanea la ruta solicitada de manera segura y envía el árbol jerárquico de vuelta.
 */
@ClientHandler(DirectoryQuery.class)
