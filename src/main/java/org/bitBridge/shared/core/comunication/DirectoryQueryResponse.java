...
public class DirectoryQueryResponse extends Communication {
    ...
    public DirectoryQueryResponse() {
        super(CommunicationType.DIRECTORY_QUERY_RESULT);
    }

    public DirectoryQueryResponse( NodoDirectorio nodo) {
        super(CommunicationType.DIRECTORY_QUERY_RESULT);
        this.nodo = nodo;
    }
    ...
    public List<NodoDirectorio> getNodos() {
        return nodos;
    }
    ...
    public void setType(CommunicationType communicationType) {
        super.setType(communicationType);
    }
    ...
    public void setNodos(List<NodoDirectorio> nodos) {
        this.nodos = nodos;
    }

    public void setNodo(NodoDirectorio nodo) {
        this.nodo = nodo;
    }
